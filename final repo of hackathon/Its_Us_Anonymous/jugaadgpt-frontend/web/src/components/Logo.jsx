...
export const JugaadMark = ({ size = 32, face = true, dots = true, stamp = false, accent }) => {
...
export const JugaadWordmark = ({ size = 28, color = 'var(--jg-ink)' }) => (
...
export const ExtIcon = ({ size = 28, variant = 'idle', label }) => {
  return (
    <div style={{
