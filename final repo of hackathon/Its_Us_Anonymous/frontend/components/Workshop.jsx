// Workshop.jsx — "Log your problem. Use what you have. Build what you need."
      ...
      <div style={{ maxWidth: 980, margin: '0 auto', position: 'relative', paddingTop: 8 }}>
        ...
        <div style={{ marginBottom: 22 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: 10 }}>
            <IcoPencil size={18} stroke={1.6} style={{ color: 'var(--jg2-brick)', marginTop: 1, transform: 'rotate(-12deg)' }}/>
        ...
        <div className="jg2-card" style={{ marginBottom: 18 }}>
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              <IcoListCheck size={18} stroke={1.7} />
          ...
          <div className="jg2-card">
            <div style={{
              ...
              <button className="jg2-btn-navy" style={{ height: 30, padding: '0 12px', fontSize: 11 }}>
                <IcoCamera size={14} stroke={1.7}/> Scan Item
              </button>
            </div>
        ...
        <div style={{
          ...
          <button style={{
            ...
            Generate Solution <IcoSparkle size={18} stroke={2}/>
          </button>
        </div>
        ...
        <div style={{
          ...
          <IcoTools size={20} stroke={1.6} style={{ color: 'var(--jg2-mute)' }}/>
        </div>
      </div>
    </AppShell>
  );
...
const ScrapRow = ({ num, label, muted }) => (
  <div style={{
    ...
    {muted
      ? <IcoPlus size={16} stroke={1.8} style={{ color: 'var(--jg2-mute)' }}/>
      : <IcoX size={15} stroke={1.8} style={{ color: 'var(--jg2-brick)' }}/>}
  </div>
);
